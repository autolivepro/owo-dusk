...
# Always run from the bot's own project directory.
# This keeps config/, utils/data/, tokens.txt, etc. working when
# Pterodactyl launches /home/container/owo-dusk/uwu.py from /home/container.
